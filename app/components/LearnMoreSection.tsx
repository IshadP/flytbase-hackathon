  ...
  return (
    <section className="relative bg-[#070709] border-t border-white/10 py-32 sm:py-40 text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-10 text-center">
        ...
        <h2
          className="font-display font-bold text-white tracking-wider leading-[1.05] mb-6"
          style={{ fontSize: 'clamp(2.4rem, 6vw, 5rem)' }}
        >
          LEARN MORE ABOUT<br />PHYSICAL AI AT NESTGEN
        </h2>

        <p className="font-body text-white/50 text-lg leading-relaxed max-w-xl mx-auto mb-12">
